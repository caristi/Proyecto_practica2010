...
<script type="text/javascript">
    ...
    <% using (Html.BeginForm(Html.BeginForm("editarasigSuper", "Asignacion", FormMethod.Post, new { enctype = "multipart/form-data" }))) {%>
         ...
         <table><tr><th>Número</th><td width="605px"><%= Html.TextBoxFor(model => model.asi_id, new { style = "width:92px;", disabled = true })%></td></tr></table>
             ...
             <table>
               <tr>
                 ...
                 <th>Solicitante</th>
                 <td>
                  <%= Html.TextBoxFor(model => model.asi_solicitante, new { style = "width:200px;" ,disabled = true})%>
                 </td>
                 <td>
            ...
            <table>
             ...
             <tr>
                <td>
                  <%= Html.TextAreaFor(model => model.asi_comentario, 6, 38, new { disabled = true })%>
                </td>
                <td>
