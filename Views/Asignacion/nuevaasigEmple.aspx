...
<script type="text/javascript">
    ...
    <% using (Html.BeginForm("registrarasigEmple","Asignacion", FormMethod.Post, new { enctype = "multipart/form-data" }))
       {%>
 ...
 <center>
            ...
            <table>
               <tr>
                <td>
                 <div>Descripción</div>
                 <div>
                  <%= Html.TextAreaFor(model => model.asi_descripcion,4,82,null) %>
            ...
            <table>
                ...
                <%= Html.Hidden("use_id",ViewData["usuarios"])%>
