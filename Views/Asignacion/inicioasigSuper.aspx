<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/InicioSuper.Master" Inherits="System.Web.Mvc.ViewPage<Sigacun.Helpers.PaginatedList<Sigacun.Models.asignaciones>>" %>
...
<script type="text/javascript">
   ...
   <br />
    ...
    <% foreach (var item in Model) { %>
        ...
        <tr>
            <td width="56px">
                <a href="<%= Url.Action("editarasigSuper",new {id=item.asi_id })  %>"><img src="/Content/iconos/edit.ico" alt="Editar" border="0" title="Editar"></a>
                <a href="<%= Url.Action("detalleSuper",new { id=item.asi_id })  %>"><img src="/Content/iconos/detail.ico" alt="Detalle" border="0" title="Detalle"></a>
    ...
    <p>
    <br />
        <%= Html.ActionLink("Registrar Asignacion", "nuevaasigSuper") %>
    </p>
