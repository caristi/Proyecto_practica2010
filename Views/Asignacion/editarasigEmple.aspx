...
<script type="text/javascript">
    ...
    <% using (Html.BeginForm(Html.BeginForm("editarasigEmple", "Asignacion", FormMethod.Post, new { enctype = "multipart/form-data" }))) {%>
        ...
        <fieldset>
            ...
            <table><tr><th>Número</th><td width="605px"><%= Html.TextBoxFor(model => model.asi_id, new { style = "width:92px;", disabled = true })%></td></tr></table>
             ...
             <tr>
               <td>             
                  <%= Html.DropDownList("act_id", (SelectList)ViewData["actividades"], "-Seleccionar uno-", new { style = "width:365px;", disabled = true })%>
                  <%= Html.ValidationMessageFor(model => model.act_id) %>
               </td>
               <td>
                <div>
                  <%= Html.DropDownList("pri_id", (SelectList)ViewData["prioridades"], new { style = "width:115px;", disabled = true })%>
                  <%= Html.ValidationMessageFor(model => model.pri_id) %>
                </div>               
               </td> 
               <td>
                 <%= Html.TextBox("asi_fechaterminar", null,new { disabled = true })%>
             ...
             <table>
               <tr>
                 ...
                 <th>Solicitante</th>
                 <td>
                  <%= Html.TextBoxFor(model => model.asi_solicitante, new { style = "width:199px;" ,disabled = true})%>
                 </td>
                 <td>
                  <%= Html.DropDownList("est_id",(SelectList)ViewData["estado"], new { style = "width:98px;"}) %>
                 </td>
               </tr>
             </table>
             <table>
                <tr>
                 <th>Fecha Inicio</th>
                 <td> 
                    <%= Html.TextBoxFor(model=>model.asi_fhinicio, new{style = "width:248px;", disabled = true}) %>
                 </td>
                 <th>Fecha Fin</th>
                 <td>
                    <%= Html.TextBoxFor(model => model.asi_fhfin, new {style = "width:248px;", disabled = true })%>
                 </td>
                </tr>
             </table>
            ...
            <table>
               ...
               <tr>
                <td>
                 <div>
                  <%= Html.TextAreaFor(model => model.asi_descripcion, 3, 82, new { disabled = true})%>
             ...
             <table>
             <tr>
             <th>Fecha y Comentario empleado</th>
             </tr>
             <tr>
                <td>
             ...
             <tr>
                <td>
                  <%= Html.TextAreaFor(model=>model.asi_comentario,3,82,null) %>
                </td>
             </tr>
             </table>
             <table>
