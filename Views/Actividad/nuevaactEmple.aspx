<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/SiteEmpleado.Master" Inherits="System.Web.Mvc.ViewPage<Sigacun.Models.actividades>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("registraractEmple", "Actividad", FormMethod.Post, new { enctype = "multipart/form-data" })) {%>
...
<center>
            ...
            <div>
  <%= Html.ActionLink("Atras", "inicioactEmple") %>
    </div>
