<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/SiteEmpleado.Master" Inherits="System.Web.Mvc.ViewPage<Sigacun.Helpers.PaginatedList<Sigacun.Models.actividades>>" %>
...
<br />
    ...
    <% foreach (var item in Model) { %>
        ...
        <tr>
            <td width="56px">
            <a href="<%= Url.Action("editaractEmple",new { id=item.act_id })  %>"><img src="/Content/iconos/edit.ico" alt="Editar" border="0" title="Editar"></a>
            <a href="<%= Url.Action("detalleEmple",new { id=item.act_id })  %>"><img src="/Content/iconos/detail.ico" alt="Detalle" border="0" title="Detalle"></a>
                <%-- Ajax Eliminar --%>  
    ...
    <br />
        <%= Html.ActionLink("Registrar actividad", "nuevaactEmple") %>
    </p>
