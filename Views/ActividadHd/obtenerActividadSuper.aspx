<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/InicioSuper.Master" Inherits="System.Web.Mvc.ViewPage<Sigacun.Models.actividades_hd>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("editaracthdsuper","ActividadHd")) {%>
        <%= Html.ValidationSummary(true) %>
      <div>
        <%= Html.ActionLink("Atras", "inicioMesaAyudaSupervisor")%>
    </div>      
        <fieldset>
             ...
             <table>
              ...
              <br />
                ...
                <table>
                    ...
                    <tr>
                        <td>
                          <%= Html.TextAreaFor(model => model.ahd_comentario, new { style = "width:335px; height: 90px;", disabled = true })%>
