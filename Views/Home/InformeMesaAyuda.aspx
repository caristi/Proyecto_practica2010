...
<script type="text/javascript">
    ...
    <fieldset>
        ...
        <table width="450px">  
           <tr>
             <th width="200px"><b>Empleado: </b></th>
       ...
       <table width="450px">           
        ...
        <td>
            ...
            <%}
               ...
               {%>
                <%= Html.ActionLink(ViewData["cantidadCasos"].ToString(), "casosPersona", new { id = ViewData["id_user"], finicio = ViewData["finicio"], ffin = ViewData["ffin"] })%>
            <%} %>
        </td>            
        </tr>
        ...
        <th width="200px">Promedio de calificacion:</th>
        <% if (ViewData["calificacion"].ToString().CompareTo("-1") == 0) { %>
             
                <td> No hay Calificaciones</td>        
           <%} 
           else{%>
                <td> <%= Html.Encode(ViewData["calificacion"])%></td>
                <%} %>
        </tr> 
        </table>
